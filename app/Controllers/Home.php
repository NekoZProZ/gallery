...
public function data_user()
	...
	public function gallery()
	{
		...
		$data['clara'] = $model->whereshow('tb_gallery',$where);
	...
	public function absen()
	{
		...
		echo view('header', $this->logo);
		echo view('menu', $this->logo);
		// $where=array('tb_pesan.id_user' => session()->get('id'));
		// $data['clara'] = $model->jointwowhere('tb_pesan','tb_users','tb_jenis','tb_pesan.id_user=tb_users.id_user','tb_pesan.jenis_pesanan=tb_jenis.id_jenis',$where);
		echo view('absen');
		echo view('footer');
		//echo view('theme_panel');
		}else{
	...
	public function edit_gallery($id)
	{
		...
		$data['clara'] = $model->getwhere('tb_gallery',$where);
	...
	public function aksi_edit_gallery($id)
	{
			...
			// 'username'=>$us
			// );
			$model->edit('tb_gallery', $isi, $where);
	...
	public function tambah_gallery()
	{
		...
		echo view('header', $this->logo);
		echo view('menu', $this->logo);
		// $data['clara'] = $model->tampil('tb_jenis');
		echo view('tambah_gallery');
		echo view('footer');
		//echo view('theme_panel');
		}else{
		return redirect()->to('home/login');
	...
	public function aksi_tambah_gallery()
	{
