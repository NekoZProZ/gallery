...
<?php if(session()->get('level')==1){
 ?>
                        ...
                        <!-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/data_barang') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">List Pesanan</span></a></li> -->
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?= base_url('home/gallery') ?>" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span class="hide-menu">Gallery</span></a></li>
