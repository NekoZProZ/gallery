<div class="page-breadcrumb">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?=base_url('home/aksi_edit_gallery/'.$clara->id_gallery)?>">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="lname" name="des" value="<?= $clara->deskripsi ?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
